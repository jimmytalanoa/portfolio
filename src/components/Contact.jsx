    ...
    return (
        <div className='flex flex-col mb-10 mx-auto'>
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/zbxdkgnb" method="POST" className="flex flex-col w-full md:w-7/12">
                ...
                <textarea name="message" placeholder="Message" className="p-2 mb-4 bg-transparent border-2 rounded-md focus:outline-none" rows="10" />
